...
It appears that the elastic net logistic regression model has the highest accuracy at `r round(max(elastic$results$Accuracy) * 100, 2)`%, which means I will be selecting this model going forward.
